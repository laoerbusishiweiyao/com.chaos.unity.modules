...
namespace UnityEngine
{
    ...
    [AddComponentMenu("DataBinding/GraphicRaycastTargetCompareBinder")]
    public sealed class GraphicRaycastTargetCompareBinder : DataBinderBehaviour
    {
        ...
        public override void Refresh()
        {
            ...
            {
                this.Target.raycastTarget = false;
                return;
            }
            ...
            this.Target.raycastTarget = this.GetValue(this.FirstDataBinder());
        }
